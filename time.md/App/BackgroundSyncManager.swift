...
/// into the persistent time.md history database every 4 hours, even when the
/// app isn't running.
///
...
/// shows **"time.md"** (not the generic developer name) in the background-
