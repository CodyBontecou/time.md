# Timeprint Device Activity Monitor Extension
...
4. Configure:
   - Product Name: `TimeprintDeviceActivityMonitor`
   - Bundle Identifier: `com.codybontecou.TimeprintIOS.DeviceActivityMonitor`
...
- NSExtensionPrincipalClass: `$(PRODUCT_MODULE_NAME).TimeprintMonitor`
...
Or replace the entitlements file with `TimeprintDeviceActivityMonitor.entitlements`
...
System tracks usage in background
        │
        ▼
TimeprintMonitor.intervalDidEnd() called
        │
        ▼
