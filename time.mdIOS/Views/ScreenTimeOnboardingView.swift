    ...
    var body: some View {
        VStack(spacing: 32) {
            ...
            VStack(spacing: 12) {
                ...
                Text("time.md can track your iPhone screen time directly, giving you detailed insights into your digital habits.")
                    .font(.body)
    ...
    var body: some View {
        VStack(spacing: 32) {
            ...
            VStack(spacing: 12) {
                ...
                Text("To track your iPhone usage, time.md needs Screen Time permission. Here's what that means:")
                    .font(.body)
                    .foregroundStyle(.secondary)
                    .multilineTextAlignment(.center)
                    .padding(.horizontal, 24)
        ...
        VStack(spacing: 32) {
            ...
            if authService.isLoading {
                ...
                VStack(spacing: 16) {
                    ...
                    Text("time.md can now track your screen time.")
                        .font(.body)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
                }
        ...
        VStack(spacing: 32) {
            ...
            if isAuthorized {
                ...
                VStack(spacing: 16) {
                    ...
                    Text("time.md will now track your screen time and sync it across your devices.")
                        .font(.body)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
                        .padding(.horizontal, 24)
