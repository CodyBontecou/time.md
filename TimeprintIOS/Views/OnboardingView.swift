...
struct OnboardingView: View {
    ...
    private let pages: [OnboardingPage] = [
        ...
        OnboardingPage(
            ...
            subtitle: "Timeprint reads Screen Time data from your Mac and syncs it via iCloud",
            features: [
                Feature(icon: "desktopcomputer", text: "Install Timeprint on your Mac"),
